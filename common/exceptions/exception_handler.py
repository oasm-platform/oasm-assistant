...
from common.schemas.sche_base import ResponseSchemaBase


class ExceptionType(enum.Enum):
    MS_UNAVAILABLE = 500, '990', 'System unavailable, please try again later'
    MS_INVALID_API_PATH = 500, '991', 'System unavailable, please try again later'
